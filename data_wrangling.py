...
feat_names = None
savePath = 'C:\\Users\\ashish\\Desktop\\data'
subject_feature_path = os.path.join("",'subject_feats')
...
class SubjectData:
    ...
    def __init__(self, main_path, subject_number):
        ...
        #print(os.path.join(os.path.join(main_path, self.name) , self.name + '.pkl'), 'rb')
        #print(os.path.join(os.path.join(main_path, self.name) , self.name + '.pkl'))
        
        with  open(os.path.join(os.path.join(main_path, self.name) , self.name + '.pkl'), 'rb') as file:
...
def make_patient_data(subject_id):
    ...
    subject = SubjectData(main_path=os.path.join('data','WESAD'), subject_number=subject_id)
